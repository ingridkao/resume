                ...
                <div class="modal-wrapper">
                    <div class="modal-container">
                        ...
                        <div class="modal-body">
                            <div class="imgGroup" v-for="(pic, index) in displayImg">
                                <img :src="pic" />
                                <p>
                                    {{picText[index]}}
        ...
        updatedialog() {
            ...
            switch(this.type) {
                case 1:
                    ...
                    vm.displayImg = [require('./assets/1-1.jpg'), require('./assets/1-2.jpg'), require('./assets/1-3.jpg'), require('./assets/1-4.jpg')];
                    vm.imgResouce = '照片來源：新北市觀光旅遊局《新北登山小旅行》';
                    vm.picText = ['金字碑', '金字碑古道入口處', '金字碑古道出口', '探幽亭及奉憲示禁碑'];
                ...
                case 8:
                    ...
                    vm.displayImg = [require('./assets/8-1.jpg'), require('./assets/8-2.jpg'), require('./assets/8-3.jpg')];
                    vm.imgResouce = '照片來源：新北市觀光旅遊局《新北登山小旅行》';
                    vm.picText = ['金瓜寮自行車道', '金瓜寮魚蕨步道', '保仁宮牌樓'];
